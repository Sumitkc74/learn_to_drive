<section class="ltd-panel ltd-admin-tools">
    ...
    <div class="ltd-admin-tools__grid">
        @foreach([
            [route('learningContent', ['status' => 'Pending']), 'fa-book-reader', 'Learning Content', 'Review official question banks and sign sheets'],
            [route('governmentNotices', ['status' => 'Pending']), 'fa-landmark', 'Government Notices', 'Review official notice suggestions'],
