...
<div class="ltd-form-shell">
    <form class="ltd-form-card" action="{{ route('insertUser') }}" method="POST" enctype="multipart/form-data" data-add-form>
        ...
        <div class="ltd-form-card__body">
            ...
            <section class="ltd-form-section"><h3 class="ltd-form-section__title">Sign-in and access</h3><p>User and Premium User accounts sign in at <a href="{{ route('learn.login') }}">{{ route('learn.login') }}</a>. To test another account while signed in as admin, use a private browser window.</p><div class="row">
