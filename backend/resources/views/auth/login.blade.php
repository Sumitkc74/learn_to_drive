...
<html>
  <head>
    ...
    <title>Log in &middot; Learn To Drive</title>
    <style>
        :root {
            --charcoal: #3B3B3B;
        ...
        * { box-sizing: border-box; }
        ...
        .forgot-link:hover { border-color: var(--muted); }
  ...
  <body>
    ...
    <main>
        ...
        <p>For User and Premium User accounts, <a class="forgot-link" href="{{ route('learn.login') }}">use learner sign-in &rarr;</a></p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="submit-row">
                <button type="submit" class="cta">{{ __('Log in') }}</button>
