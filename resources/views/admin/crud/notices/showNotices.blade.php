...
@section('content')
    ...
    <div class="ltd-panel">
        <div class="d-flex justify-content-between align-items-center mb-3 flex-wrap gap-2">
            ...
            <div><a href="{{ route('governmentNotices') }}" class="btn btn-sm btn-outline-primary mr-2"><i class="fas fa-landmark"></i> Government Imports</a><a href="{{ route('noticeTrash') }}" class="btn btn-sm btn-outline-secondary mr-2"><i class="fas fa-trash-restore"></i> Trash</a><a href="{{ URL::to('/admin/add-notice/') }}" class="btn btn-sm btn-success">
